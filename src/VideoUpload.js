...
const ElegantWandSearch = () => {
  ...
  const handleShowCoupons = () => {
    if (!couponsDownloaded) {
      const couponImages = [
        { src: '/img/imagen1.png', name: 'cupon1.png' },
...
// import { X, Wand2 } from 'lucide-react';
// import '../src/clickGame.css';
// import { FaClock, FaBook, FaFeatherAlt, FaKey, FaRing } from 'react-icons/fa';

// const objects = [
//   { name: 'Reloj', icon: <FaClock className="w-16 h-16 mx-auto" /> },
//   { name: 'Libro', icon: <FaBook className="w-16 h-16 mx-auto" /> },
//   { name: 'Pluma', icon: <FaFeatherAlt className="w-16 h-16 mx-auto" /> },
//   { name: 'Varita', icon: <Wand2 className="w-16 h-16 mx-auto" /> },
//   { name: 'Llave', icon: <FaKey className="w-16 h-16 mx-auto" /> },
//   { name: 'Anillo', icon: <FaRing className="w-16 h-16 mx-auto" /> },
// ];
...
//   const [score, setScore] = useState(0);
//   const [currentImage, setCurrentImage] = useState('');
//   const [couponsViewed, setCouponsViewed] = useState(0);
//   const [couponsDownloaded, setCouponsDownloaded] = useState(false);

//   const audioRef = useRef(new Audio('/img/music.mp3')); // Usamos useRef para mantener la misma instancia
